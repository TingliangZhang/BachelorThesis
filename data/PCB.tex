...
CP2102N-A01-GQFN20R作为USB-UART芯片，不使用其内置3.3V电压转换模块，通过此芯片可以直接通过USB给ESP32烧写程序。优点是廉价，缺点则为CP2102N只能烧写程序，而不能作为 USB-to-JTAG 接口进行ESP32和计算机的实时通信桥梁。
...
后更新为QFN-24_4x4x05P封装的CP2104-F03-GMR芯片，如图~\ref{fig:CP2104-F03-GMR}，这一版本的设计参考了官方Datasheet和Github开源项目ESP-Debugger\footnote{\url{https://github.com/xiongyumail/ESP-Debugger}}中的部分电路。
