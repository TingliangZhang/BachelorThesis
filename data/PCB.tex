...
\begin{figure}
    \begin{minipage}{0.48\textwidth}
      \centering
      \includegraphics[height=4cm]{xbee-zigbee-smt-XB24CZ7RIS-004.jpg}
      \caption{Digi XBee ZigBee SMT, PCB Antenna}
      \label{fig:XB24CZ7RIS-004}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
      \centering
      \includegraphics[height=4cm]{digi-xbee3-smt-pcb-hero.jpg}
