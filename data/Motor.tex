...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\columnwidth]{step-motor-current-1.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\columnwidth]{step-motor-current-2.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\columnwidth]{step-motor-current-3.jpg}
