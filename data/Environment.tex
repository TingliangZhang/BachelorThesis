...
在Arduino IDE中，确保 Tools > Board 选项是对的，之后开始 Tools > Burn Bootloader 等待约15秒即可。
...
在 GND 和 RESET之间连接一个10uF的电容，并将Arduino Uno (or Mega)如表~\ref{tab:ICSP}所示的引脚连接到要烧写芯片的对应ICSP引脚上。
...
只要找到对应的ICSP引脚，烧写ATMega2560和ATmega16U2的操作基本一致。
