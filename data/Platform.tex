...
研究一个装有三个Mecanum轮，车轮中心为$A_{i}\left(a_{i x}, a_{i y}\right)$，主动轮轮轴角$\alpha_{i}, i=1,2,3$的小车，如果我们用$\omega_i$表示每个车轮的角速度，则根据等式~\ref{eq:u}我们有：
